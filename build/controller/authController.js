...
var sendVerificationEmail = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(user, emailVerificationToken) {
    var transporter, verificationUrl;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          verificationUrl = "".concat(process.env.BASE_URL, "api/v1/user/verify-email?token=").concat(emailVerificationToken);
          _context.next = 4;
          return transporter.sendMail({
            from: '"Hệ thống tư vấn tuyển sinh" <hongquanvd1@gmail.com>',
            to: user.email,
            subject: 'Verify Email',
            text: "Please click on the following link to verify your email: ".concat(verificationUrl)
          });
        case 4:
        case "end":
...
var register = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _req$body, username, email, password, hashedPassword, checkExistUser, user, emailVerificationToken;
      ...
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 13:
          ...
          return _context3.abrupt("return", res.status(403).json({
            message: "Tài khoản chưa được kích hoạt. Kiểm tra email của bạn"
          }));
        case 15:
          token = jwt.sign({
            id: user.user_id,
...
//Hàm xác thực email
var emailVerify = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 5:
          ...
          return _context4.abrupt("return", res.status(400).send('Invalid token.'));
        case 8:
  ...
  return function emailVerify(_x7, _x8) {
...
var requestPasswordReset = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var email, user, resetToken, transporter, resetUrl;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 4:
          ...
          return _context5.abrupt("return", res.status(404).send("Không tìm thấy người dùng với email này."));
        case 7:
          resetToken = jwt.sign({
            userId: user.user_id
          }, process.env.JWT_SECRET, {
        ...
        case 11:
          ...
          resetUrl = "".concat(process.env.REACT_URL, "reset-password?token=").concat(resetToken);
          _context5.next = 15;
          return transporter.sendMail({
            from: '"Hệ thống tư vấn tuyển sinh" <hongquanvd1@gmail.com>',
            to: user.email,
            subject: 'Reset Password',
            text: "Vui l\xF2ng nh\u1EA5p v\xE0o li\xEAn k\u1EBFt sau \u0111\u1EC3 \u0111\u1EB7t l\u1EA1i m\u1EADt kh\u1EA9u c\u1EE7a b\u1EA1n: ".concat(resetUrl)
          });
        case 15:
  ...
  return function requestPasswordReset(_x9, _x10) {
...
var resetPassword = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    var _req$body3, token, newPassword, decoded, user, hashedPassword;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 5:
          ...
          return _context6.abrupt("return", res.status(400).send('Token không hợp lệ hoặc đã hết hạn.'));
        case 8:
          _context6.next = 10;
...
var changePassword = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(req, res) {
    var _req$body4, currentPassword, newPassword, id, user, isMatch, hashedPassword;
